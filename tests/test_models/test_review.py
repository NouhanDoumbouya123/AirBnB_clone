...
review = __import__("models").review
...
class TestReview(unittest.TestCase):
    ...
    def test_place_id_attr(self):
        """Test that Review has attribute place_id, and it's an empty string"""
        review = Review()
        self.assertTrue(hasattr(review, "place_id"))
        self.assertEqual(review.place_id, "")

    def test_user_id_attr(self):
        """Test that Review has attribute user_id, and it's an empty string"""
        review = Review()
        self.assertTrue(hasattr(review, "user_id"))
        self.assertEqual(review.user_id, "")

    def test_text_attr(self):
        """Test that Review has attribute text, and it's an empty string"""
        review = Review()
